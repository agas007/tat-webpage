        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="w-full lg:w-1/2">
            <div className="relative">
              ...
              <div className="absolute -bottom-10 -right-10 bg-white p-6 rounded-2xl shadow-2xl flex flex-col gap-2 max-w-[200px]">
                <h3 className="text-5xl font-extrabold text-brand-blue">15+</h3>
                <p className="text-brand-dark font-medium leading-tight">Tahun melayani sebagai mitra Anda</p>
              </div>
            </div>
          </div>
          
          <div className="w-full lg:w-1/2 space-y-6 lg:pl-10">
            <h4 className="text-brand-blue font-semibold uppercase tracking-wider text-sm">Siapa Kami</h4>
            <h2 className="text-3xl md:text-5xl font-bold text-brand-dark leading-tight">Lebih Dari Sekadar Konsultan.</h2>
            ...
            <ul className="space-y-4 pt-6">
              {[
                ...
                <li key={idx} className="flex items-start gap-4">
                  ...
                  <span className="text-brand-dark font-medium pb-1 border-b border-gray-100">{item}</span>
                </li>
              ))}
            </ul>
          </div>
